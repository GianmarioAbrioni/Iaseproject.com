/**
 * IASE Project - Staking Job per server in memoria
 * 
 * Versione del job di verifica staking ottimizzata per il server in memoria
 * con persistenza su file.
 */
...
// Setup iniziale
console.log("🔄 IASE Project - Job Verifica Staking");
console.log("⚙️ Modalità: In-memory con persistenza su file");
